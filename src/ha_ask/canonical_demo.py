...
class CanonicalDemoResult(TypedDict):
...
def _response_for(field_path: str, answer_value: str) -> dict[str, Any]:
    if field_path == "consent_to_contact":
        return {
            ...
            "meta": {"ask_session_id": "canonical-session-consent", "replies": []},
            "error": None,
        }
    if field_path == "preferred_contact_method":
        return {
            ...
            "meta": {"ask_session_id": "canonical-session-contact", "replies": []},
            "error": None,
        }
    if field_path == "timezone":
        return {
            ...
            "slots": {},
            "meta": {"ask_session_id": "canonical-session-timezone", "replies": [answer_value]},
            "error": None,
        }
